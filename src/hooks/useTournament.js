...
const useTournament = () => {
  ...
  const startTournament = async (playerNames, numTables, bonusPointsEnabled, bonusPointsPerMatch, fixedTeams, handsPerMatch, setView, setShowShareModal) => {
    ...
    try {
      ...
      if (tournamentData) {
        ...
        setTournament({
          ...
          handsPerMatch: tournamentData.handsPerMatch || 4,
        });
        setView('tournament');
      } else {
